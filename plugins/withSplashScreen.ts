...
/**
 * Implement Android config plugin - the only platform needed for this plugin.
 * However, follow good practice by breaking up all config plugins from the
 * exported function into parts by platform. For example, if needed, also add
 * `withIosSplashScreen` for the iOS implementation.
 */
