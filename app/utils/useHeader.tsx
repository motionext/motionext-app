...
export function useHeader(
  ...
  /**
   * Need to have multiple implementations of this hook for web and mobile.
   * Web needs to use useEffect to avoid a rendering loop.
   * In mobile and also to avoid a visible header jump when navigating between screens, use
  ...
  // Use `useLayoutEffect` to avoid a visible header jump when navigating between screens.
  // This will apply the settings before the screen renders.
  usePlatformEffect(() => {
