 ...
 *
 * Because FlashList's props are a superset of FlatList's, must pass estimatedItemSize
 * to this component if want to use it.
 *
 * Use a temporary workaround until the FlashList component supports RTL.
 * Once supported, remove this component and default to using FlashList everywhere.
