...
/**
 * Handle whenever the user encounters a JS error in the app. Follow the
 * "error boundary" pattern in React. Use a class component because, according
 * to the documentation, only class components can be error boundaries.
...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    // It's also possible to log error messages to an error reporting service here
    reportCrash(error)
  }
